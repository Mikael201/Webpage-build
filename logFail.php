...
<div class="list">
	...
	if (isset($_SESSION['userId']))
	{
		...
		echo '	<form name="unusedForm" action="logIn.php" class="unusedClass" method="POST"> 
				<input type="submit" name ="click" class="nappi" id="backButton" value="Back" />
				</form>';
	}

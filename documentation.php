...
<div class="aboutColumn">
	<div class="column1">
	<form name="formi" action="realDocumentation.php" method="POST"> 
	
	
		Password:<br>
			<input type="password" id="inputText" name="name" value="">
			<br><br>
			<input type="submit" name ="Result" id="nappulat" value="Login" />
			<br>
	</form>		
	</div>
</div>	

...
<div class="list">
	...
	<div class="aboutColumn">
	<div class="column1">
	<form name="contactForm" action="catchContact.php" onsubmit="return checkingContact()" method="POST"> 
	Name:<br>
			<input type="text" id="inputText" name="name" value="" placeholder="e.g. Hemuli Hemulensson"/>
			<br>
	Email:<br>
			<input type="text" id="inputText" name="email" value="" placeholder="e.g. Hemuli@student.uwasa.fi"/>
			<br>
	Comment:<br>
			<textarea id="inputText" name="customerComment" placeholder="e.g. Hello I have feedback for you..."></textarea>
			<br><br>
			
			<input type="submit" name ="Result" class="nappi" id="nappulat" value="Send" />
			<br><br>
			<input type="reset" id="nappulat" value="Reset">

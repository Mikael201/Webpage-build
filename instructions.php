...
<div class="list">
	...
	<br>
		...
		<p class="column1">
		Create an account and start tracking Your pet's meals. 
		In our website You, as an user can save all the meals Your pet has eaten. 
		After creating Your account You will be able to create a specific meal tracking software for Your pet. 
		Remember to save your Username and Password in a safe and reliable place. 
		</p>
		</div>

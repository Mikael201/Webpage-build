		...
		if((isset($_SESSION['globalName']))) 
		{
			...
			echo '	<div class="aboutColumn"> 
						<div class="column1">
							...
							<strong>This is Your personal page for Tracking!<br><br>   
							What you want to do? </strong>   
						
					<br><br><br>
					<div class="actions">
					
					<form name="insertForm" action="insert.php" class="unusedClass" method="POST"> 
						<input type="submit" name ="Result" class="nappi" id="btns" value="Meal insertion" />
					</form><br>
					
					
					
				   <form name="printForm" action="print.php" class="unusedClass" method="POST"> 
						<input type="submit" name ="Result" class="nappi" id="btns" value="Meal printing and deleting" />
					</form><br>
					
					<form name="deleteAccountForm" action="deleteAccountSure.php" class="unusedClass" method="POST"> 
						<input type="submit" name ="Result" class="nappi" id="btns" value="Delete user" />
					</form>

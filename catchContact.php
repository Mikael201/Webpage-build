...
<div class="list">
	...
	$send = mail($email, $name, $comment);
	var_dump($send);
	
	echo'
	<div class="aboutColumn">
	<p class="column1">Your comment was sent to Us and we will reply to You as soon as possible. A draft of your comment has been sent to your email-address.</p>
	</div>';
	}
	else
	{

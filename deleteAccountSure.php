	...
	<br>
		...
		if((isset($_SESSION['globalName']))) 
		{
			...
			echo '	<div class="aboutColumn"> 
					...
					<br>
				   <form name="printForm" action="deleteAccount.php" class="unusedClass" method="POST"> 
						<input type="submit" name ="Result" class="nappi" id="btns" value="Yes" />
					</form><br>
					
					<form name="deleteAccountForm" action="loggedPage.php" class="unusedClass" method="POST"> 
						<input type="submit" name ="Result" class="nappi" id="btns" value="No" />
					</form>

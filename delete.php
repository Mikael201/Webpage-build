...
echo '	<div class="aboutColumn">
		<div class="column1">
		<form name="deleteMeal" action="mealDeleteForm.php" onsubmit="return checkInteger()" method="POST">
		ID to remove:<br>
		<input type="text" id="inputText" name="idRow" value="" placeholder="e.g. 5"/>
		<br>
		<br>
		<input type="submit" name ="Result" class="nappi" id="btns" value="Delete" />

...
if(isset($_SESSION["globalName"]))
{
	...
	$username = $_SESSION['globalName'];
		...
		$sql = "SELECT id, name, meal, day, time FROM $username";
					...
					while($row = $result->fetch_assoc()) 
						{
							...
							echo "
												<div class='aboutColumn'>
													<div class='column1'>
														<strong>id:</strong> " . $row["id"]. " - <strong>Name:</strong> " . $row["name"]. " - <strong>Meal:</strong> " . $row["meal"]. " - <strong>Day:</strong> " . $row["day"]. " - <strong>Time:</strong> " . $row["time"] . ' <a href="deleteRow.php\?id=' . $row["id"]. '">Delete &#8614</a>';
												echo	"</div>
												</div>	
			...
			else 
			{
				...
				echo '
												<div class="aboutColumn">
													<div class="column1">
													<strong>No meals found at all</strong>
													</div>
												</div>	
